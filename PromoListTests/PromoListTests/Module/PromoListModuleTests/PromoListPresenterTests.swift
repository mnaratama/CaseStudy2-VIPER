...
class PromoListViewSpy: PromoListViewProtocol {
    ...
    var entityCount = 0
    func displayPromoList(entity: PromoList.PromoListViewEntity) {
...
class PromoListRouterSpy: PromoListRouterProtocol {
    static func createModule(navigateToPromoDetail: @escaping (PromoList.PromoListEntity) -> Void) -> UIViewController {
        return UIViewController()
    }
    
    var routeToPromoDetailTapped = 0
    func routeToPromoDetail(entity: PromoList.PromoListEntity) {
